...
namespace ThaleTheGreat.SurfingFestival
{
    public class Mod : StardewModdingAPI.Mod
    {
        ...
        public override void Entry(IModHelper helper)
        {
            ...
            Mod.FestivalName = I18n.Festival_Name();
            Mod.Instance = this;
            ...
            Event.RegisterCommand("applySurfingFestivalIslandAttire", EventCommand_ApplySurfingFestivalIslandAttire);
        ...
        {
            Mod.FestivalName = I18n.Festival_Name();
            this.Helper.GameContent.InvalidateCache("Data/Festivals/summer5");
            this.Helper.GameContent.InvalidateCache("Data/Festivals/FestivalDates");
        ...
        private void OnAssetRequested(object? sender, AssetRequestedEventArgs e)
        {
            if (e.NameWithoutLocale.IsEquivalentTo("Data\\Festivals\\summer5"))
            {
                e.LoadFrom(() =>
                {
                    IDictionary<string, string> data = this.BuildFestivalData();
        ...
        private IDictionary<string, string> BuildFestivalData()
        {
            ...
            var data = new Dictionary<string, string>
            {
                ...
                ["set-up"] = "event2/-1000 -1000/farmer 38 3 2/changeToTemporaryMap Beach-Surfing/loadActors Set-Up/applySurfingFestivalIslandAttire/animate Robin false true 500 20 21 20 22/animate Demetrius false true 500 24 25 24 26/viewport 38 2 clamp true/pause 1000/playerControl surfing",
                ["mainEvent"] = $@"pause 500/playMusic none/pause 500/globalFade/viewport -1000 -1000/loadActors MainEvent/applySurfingFestivalIslandAttire/warpSurfingRacers/viewport 18 57 true unfreeze/pause 2000/message ""{I18n.Race_Instructions()}""/speak Lewis ""{I18n.Race_LewisStart_0()}""/speak Lewis ""{I18n.Race_LewisStart_1()}""/speak Lewis ""{I18n.Race_LewisStart_2()}""/waitForOtherPlayers actualRace/playSound whistle/playMusic cowboy_outlawsong/playerControl surfingRace",
                ["afterSurfingRace"] = "pause 100/playSound whistle/waitForOtherPlayers endContest/pause 1000/globalFade/viewport -1000 -1000/playMusic event1/loadActors PostEvent/applySurfingFestivalIslandAttire/warpSurfingRacersFinish/pause 1000/viewport 34 12 true/pause 2000/speak Lewis \"{{winDialog}}\"/awardSurfingPrize/pause 600/viewport move 1 0 5000/pause 2000/globalFade/viewport -1000 -1000/waitForOtherPlayers festivalEnd/end",
        ...
        public static void EventCommand_ApplySurfingFestivalIslandAttire(Event instance, string[] args, EventContext context)
        {
            foreach (NPC actor in instance.actors)
            {
                actor.wearIslandAttire();
                actor.shouldWearIslandAttire.Value = false;
                actor.isWearingIslandAttire = false;
