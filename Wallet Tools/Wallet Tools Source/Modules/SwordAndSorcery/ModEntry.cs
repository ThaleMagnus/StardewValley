...
internal sealed class SwordAndSorceryModule : WalletModule
{
    ...
    private void RegisterGmcm()
    {
        ...
        gmcm.AddBoolOption(ModManifest, () => Config.ModEnabled, value => SetModEnabled(value), () => Host.Translate("config.sword-and-sorcery.enabled.name"), () => Host.Translate("config.sword-and-sorcery.enabled.tooltip"), nameof(Config.ModEnabled));
        gmcm.AddBoolOption(ModManifest, () => Config.PreferSwordAndSorcerySameTierTools, value => Config.PreferSwordAndSorcerySameTierTools = value, () => Host.Translate("config.sword-and-sorcery.prefer.name"), () => Host.Translate("config.sword-and-sorcery.prefer.tooltip"), nameof(Config.PreferSwordAndSorcerySameTierTools));
        gmcm.AddBoolOption(ModManifest, () => Config.DebugLogging, value => Config.DebugLogging = value, () => Host.Translate("config.sword-and-sorcery.debug.name"), () => Host.Translate("config.sword-and-sorcery.debug.tooltip"), nameof(Config.DebugLogging));
        GmcmRegistered = true;
    }
