...
internal sealed class WalletScepterModule : WalletModule
{
    ...
    private void OnAssetRequested(object? sender, AssetRequestedEventArgs e)
    {
        ...
        e.Edit(asset =>
        {
            ...
            powers[WalletPowerId] = new PowersData
            {
                ...
                Description = Host.Translate("power.scepter.description"),
    ...
    private void RegisterMobilePhoneApp()
    {
        ...
        try
        {
            ...
            MobilePhoneApi.AddApp(LegacyUniqueId, Host.Translate("module.scepter.name"), ActivateScepterFromMobilePhone, icon);
        }
        catch (Exception ex)
        {
    ...
    private void ActivateScepterFromMobilePhone()
    {
        ...
        if (Config.RequireWalletUnlock && !HasWalletScepter(Game1.player))
        {
            if (Config.ShowHudMessageWhenMissing)
                Game1.addHUDMessage(new HUDMessage(Host.Translate("hud.scepter-missing"), HUDMessage.error_type));
    ...
    private void RegisterGmcm()
    {
        ...
        try
        {
            ...
            GmcmApi.AddKeybindList(
                ...
                name: () => Host.Translate("config.scepter.use.name"),
                tooltip: () => Host.Translate("config.scepter.use.tooltip"),
            ...
            GmcmApi.AddBoolOption(
                ...
                name: () => Host.Translate("config.scepter.auto-return.name"),
                tooltip: () => Host.Translate("config.scepter.auto-return.tooltip"),
            ...
            GmcmApi.AddBoolOption(
                ...
                name: () => Host.Translate("config.scepter.ask.name"),
                tooltip: () => Host.Translate("config.scepter.ask.tooltip"),
            ...
            GmcmApi.AddBoolOption(
                ...
                name: () => Host.Translate("config.scepter.require.name"),
                tooltip: () => Host.Translate("config.scepter.require.tooltip"),
            ...
            GmcmApi.AddBoolOption(
                ...
                name: () => Host.Translate("config.scepter.missing-message.name"),
                tooltip: () => Host.Translate("config.scepter.missing-message.tooltip"),
    ...
    private void OnUpdateTicked(object? sender, UpdateTickedEventArgs e)
    {
        ...
        if (Config.AskBeforeAutomaticReturnHomeAt2500)
            ...
            Game1.addHUDMessage(new HUDMessage(Host.Translate("hud.scepter-returned-home"), HUDMessage.newQuest_type));
    }
    ...
    private void ShowNightReturnDialogue()
    {
        Response[] responses =
        {
            new Response(NightChoiceReturnHome, Host.Translate("dialogue.scepter.return-home")),
            new Response(NightChoiceStayOut, Host.Translate("dialogue.scepter.stay-out")),
            new Response(NightChoiceGoToBed, Host.Translate("dialogue.scepter.go-to-bed"))
        };

        Game1.currentLocation.createQuestionDialogue(
            Host.Translate("dialogue.scepter.question"),
            responses,
    ...
    private void ConvertInventoryScepters(Farmer player)
    {
        ...
        InvalidatePowers();
        Game1.addHUDMessage(new HUDMessage(Host.Translate("hud.scepter-added"), HUDMessage.newQuest_type));
    }
    ...
    private string GetReturnScepterDisplayName()
    {
        ...
        {
            return Host.Translate("item.return-scepter.name");
        }
    }
