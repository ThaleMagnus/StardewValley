...
internal static partial class GraphicsDeviceExt {
    ...
    internal static unsafe class SpriteBatcherValues {
        internal static int MaxBatchSize = (int)(typeof(SpriteBatcher).GetField("MaxBatchSize", BindingFlags.Static | BindingFlags.NonPublic)?.GetValue(null) ?? 6000); //6000;//5461;
