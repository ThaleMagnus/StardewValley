...
internal static class SwordAndSorceryIntegration
{
    ...
    {
        string curseDescription = ModEntry.Translate("tools.sword-and-sorcery.curses-on-touch");

        AddSwordAndSorceryTool(tools, StygiumHoeToolId, "Hoe", "Stygium Hoe", ModEntry.Translate("tools.sword-and-sorcery.stygium-hoe.name"), "[LocalizedText Strings\\Tools:Hoe_Description] " + curseDescription, "Textures/DN.SnS/StygiumTools", 6, 17, 5, "(T)IridiumHoe", 35000, "(O)DN.SnS_StygiumBar", 5);
        AddSwordAndSorceryTool(tools, StygiumPickaxeToolId, "Pickaxe", "Stygium Pickaxe", ModEntry.Translate("tools.sword-and-sorcery.stygium-pickaxe.name"), "[LocalizedText Strings\\Tools:Pickaxe_Description] " + curseDescription, "Textures/DN.SnS/StygiumTools", 18, 29, 5, "(T)IridiumPickaxe", 35000, "(O)DN.SnS_StygiumBar", 5);
        AddSwordAndSorceryTool(tools, StygiumAxeToolId, "Axe", "Stygium Axe", ModEntry.Translate("tools.sword-and-sorcery.stygium-axe.name"), "[LocalizedText Strings\\Tools:Axe_Description] " + curseDescription, "Textures/DN.SnS/StygiumTools", 30, 41, 5, "(T)IridiumAxe", 35000, "(O)DN.SnS_StygiumBar", 5);
        AddSwordAndSorceryTool(tools, StygiumWateringCanToolId, "WateringCan", "Stygium Watering Can", ModEntry.Translate("tools.sword-and-sorcery.stygium-watering-can.name"), "[LocalizedText Strings\\Tools:WateringCan_Description] " + curseDescription, "Textures/DN.SnS/StygiumTools", 42, 50, 5, "(T)IridiumWateringCan", 35000, "(O)DN.SnS_StygiumBar", 5);

        AddSwordAndSorceryTool(tools, BlessedHoeToolId, "Hoe", "Blessed Hoe", ModEntry.Translate("tools.sword-and-sorcery.elysium-hoe.name"), "[LocalizedText Strings\\Tools:Hoe_Description]", "Textures/DN.SnS/BlessedTools", 6, 17, 6, "(T)" + StygiumHoeToolId, 50000, "(O)DN.SnS_DuskspireHeart", 1);
        AddSwordAndSorceryTool(tools, BlessedPickaxeToolId, "Pickaxe", "Blessed Pickaxe", ModEntry.Translate("tools.sword-and-sorcery.elysium-pickaxe.name"), "[LocalizedText Strings\\Tools:Pickaxe_Description]", "Textures/DN.SnS/BlessedTools", 18, 29, 6, "(T)" + StygiumPickaxeToolId, 50000, "(O)DN.SnS_DuskspireHeart", 1);
        AddSwordAndSorceryTool(tools, BlessedAxeToolId, "Axe", "Blessed Axe", ModEntry.Translate("tools.sword-and-sorcery.elysium-axe.name"), "[LocalizedText Strings\\Tools:Axe_Description]", "Textures/DN.SnS/BlessedTools", 30, 41, 6, "(T)" + StygiumAxeToolId, 50000, "(O)DN.SnS_DuskspireHeart", 1);
        AddSwordAndSorceryTool(tools, BlessedWateringCanToolId, "WateringCan", "Blessed Watering Can", ModEntry.Translate("tools.sword-and-sorcery.elysium-watering-can.name"), "[LocalizedText Strings\\Tools:WateringCan_Description]", "Textures/DN.SnS/BlessedTools", 42, 50, 6, "(T)" + StygiumWateringCanToolId, 50000, "(O)DN.SnS_DuskspireHeart", 1);
    }
