...
internal abstract class WalletModule
{
    ...
    private string DisplayNameKey { get; }
    internal string DisplayName => Host.Translate(DisplayNameKey);
    ...
    protected WalletModule(ModEntry host, string key, string displayNameKey, string legacyUniqueId, params string[] requiredModIds)
    {
        Host = host;
        Key = key;
