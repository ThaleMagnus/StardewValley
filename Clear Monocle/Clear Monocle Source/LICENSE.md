(TM) CLEAR MONOCLE LICENSE
===========================

This license applies to (TM) Clear Monocle v1.1.0.
...
- CommunityToolkit.HighPerformance — MIT License
  https://github.com/CommunityToolkit/dotnet

- FastExpressionCompiler.LightExpression — MIT License
  https://github.com/dadhi/FastExpressionCompiler

- Generic Mod Config Menu — MIT License
...
- LinqFasterer — MIT License
  https://github.com/JackMott/LinqFaster

- SpriteMaster — MPL-2.0 License
  https://github.com/aurpine/Stardew-SpriteMaster

- Stardew Modding API (SMAPI) — LGPL-3.0 License
