    ...
    public class Witch : Monster
    {
        ...
        *********/
            ...
            : base("Serpent", new Vector2(-1000, -1000))
        {
            ...
            this.speed = 7;
            this.Portrait = Mod.Instance.Helper.ModContent.Load<Texture2D>("assets/witch-portrait.png");
        }
        ...
        public override void behaviorAtGameTick(GameTime time)
        {
            ...
            if (this.SpawnRocksTimer.Value <= 0)
            {
                ...
                for (int i = 3 + Game1.random.Next(5); i >= 0; --i)
                {
                    ...
                    rock = rock + rock % 2;
                    var obj = ItemRegistry.Create<SObject>($"(O){rock}");
                    obj.TileLocation = spot;
                    obj.MinutesUntilReady = 3;
        ...
        *********/
        protected override void initNetFields()
        {
            base.initNetFields();
            this.NetFields
                .AddField(this.FacingRight)
                .AddField(this.ShootPlayerTimer)
                .AddField(this.SpawnRocksTimer)
                .AddField(this.SpawnEnemyTimer)
                .AddField(this.StunTimer);
        }
    }
}
