...
internal static class Config {
    ...
    [Attributes.GMCMHidden] internal static string PerformanceAuditMigrationVersion = "";
    ...
    [Attributes.Comment("Should Clear Monocle be enabled? Unsetting this will disable _all_ Clear Monocle functionality.")]
    [Attributes.MenuName("Enable Clear Monocle")]
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    [Attributes.Comment("Button to toggle Clear Monocle")]
...
#pragma warning restore CS0618
    ...
    internal static class Debug {
        ...
        internal static class Logging {
            internal static LogLevel LogLevel = LogLevel.Warn;
#if (!SHIPPING && !RELEASE) || LOG_MONITOR
            internal static bool SilenceOtherMods = false;
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        [Attributes.OptionsAttribute(Attributes.OptionsAttribute.Flag.FlushAllRenderingCaches)]
        internal static bool EnabledLargeText = false;
        [Attributes.Comment("Should resampling be enabled for small text?")]
        [Attributes.OptionsAttribute(Attributes.OptionsAttribute.Flag.FlushAllRenderingCaches)]
        internal static bool EnabledSmallText = false;
        ...
        [Attributes.Ignore]
        internal const Root.Resample.Scaler Scaler = Root.Resample.Scaler.xBRZ;
        [Attributes.Ignore]
        internal const Root.Resample.Scaler ScalerPortrait = Root.Resample.Scaler.xBRZ;
        [Attributes.Ignore]
        internal const Root.Resample.Scaler ScalerText = Root.Resample.Scaler.xBRZ;
        [Attributes.Ignore]
        internal const Root.Resample.Scaler ScalerGradient = Root.Resample.Scaler.xBRZ;
        ...
        internal static class Recolor {
            ...
            internal const double RScalar = 0.897642;
            internal const double GScalar = 0.998476;
            internal const double BScalar = 1.18365;
        }
    ...
    internal static class SMAPI {
        ...
        internal static bool ApplyGetDataPatch = false;
    }
    ...
    internal static class Extras {
        ...
        [Attributes.Comment("Should stack trace detection be used for Content Patcher Animations SetData compatibility?")]
        [Attributes.Advanced]
        internal static bool ContentPatcherAnimationsStackTraceDetection = false;

        [Attributes.Ignore]
        internal static bool RenderTargetStackTraceDetection = false;
        ...
        [Attributes.Ignore]
        internal static bool StableSort = false;
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        internal static class ModPatches {
            ...
            [Attributes.Comment("Disable unnecessary PyTK mitigation for Clear Monocle?")]
