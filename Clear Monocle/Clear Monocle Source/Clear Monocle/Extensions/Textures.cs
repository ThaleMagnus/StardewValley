...
internal static class Textures {
    ...
    [MethodImpl(Runtime.MethodImpl.Inline)]
    internal static string NormalizedName(this string name, in DrawingColor color) => name.NormalizeNameInternal();
    ...
    [MethodImpl(Runtime.MethodImpl.Inline)]
    internal static string NormalizedName(this ManagedTexture2D texture, in DrawingColor color) => texture.Name;
    [MethodImpl(Runtime.MethodImpl.Inline)]
    ...
    [MethodImpl(Runtime.MethodImpl.Inline)]
    internal static string NormalizedName(this ManagedSpriteInstance instance, in DrawingColor color) => instance.Name;
    [MethodImpl(Runtime.MethodImpl.Inline)]
