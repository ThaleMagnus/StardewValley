...
internal sealed class Resampler {
    ...
    private static unsafe NewTextureResult CreateNewTexture(
		...
		*/
        ...
        bool resamplingAllowed = Config.Resample.IsEnabled;
        ...
        if (scalerInfo is not null) {
            ...
            gammaCorrect = gammaCorrect && scalerInfo.GammaCorrect;
		...
		*/
        ...
        // TODO : For some reason, block compression can give incorrect results with some scalers. I need to investigate this at some point.
