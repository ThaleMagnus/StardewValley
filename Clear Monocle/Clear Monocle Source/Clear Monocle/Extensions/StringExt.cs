...
internal static class StringExt {
    ...
    [MethodImpl(Runtime.MethodImpl.Inline)]
    internal static string ToString<T>(this T? obj, in DrawingColor color) => obj?.ToString() ?? "[null]";
    ...
    [MethodImpl(Runtime.MethodImpl.Inline)]
    internal static string Colorized(this string str, DrawingColor color) => str;

    [MethodImpl(Runtime.MethodImpl.Inline)]
    internal static string Colorized(this string str, DrawingColor foregroundColor, DrawingColor backgroundColor) => str;
