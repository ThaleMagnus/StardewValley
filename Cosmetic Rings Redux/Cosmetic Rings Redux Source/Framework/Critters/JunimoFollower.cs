...
namespace ThaleMagnus.CosmeticRingsRedux.Framework.Critters
{
    internal class JunimoFollower : NPC
    {
        ...
        public JunimoFollower(Vector2 position) : base(new AnimatedSprite("Characters\\Junimo", 0, 16, 16), position * 64f, 2, "JunimoFollower", null)
        {
            base.Breather = false;
