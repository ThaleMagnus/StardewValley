...
internal static class Draw {
    ...
    private static bool ShouldBypass(XSpriteBatch batch, XTexture2D? texture) {
    ...
    public static bool OnDrawFirst(
        ...
        if (ShouldBypass(__instance, texture)) {
            return true;
        }
