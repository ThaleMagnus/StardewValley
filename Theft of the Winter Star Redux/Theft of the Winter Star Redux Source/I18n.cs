...
namespace ThaleMagnus.TheftOfTheWinterStar
{
    public static class I18n
    {
        ...
        public static string FinalBoss_PresentLocked()
        {
            return Translation.Get("final-boss.present-locked").ToString();
        }

        public static string FinalBoss_PresentEmpty()
        {
            return Translation.Get("final-boss.present-empty").ToString();
        }
